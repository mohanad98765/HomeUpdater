...
|:---:|---|---|---|
| A | الجولة الترحيبية · Onboarding | الخطوة ٤ (المستشار) ظاهرة، نقاط التقدّم واضحة | 🟣 **جديدة** |
| B | نافذة الموافقة · Consent modal | نص الموافقة على مشاركة البيانات كاملاً | 🟣 **جديدة** |
| C | خطوات الوكيل · Agent steps | الرقائق الأربع + بداية التوصية | 🟣 **جديدة** |
| D | خطة قابلة للتطبيق · Apply plan | «طبّق أهمّ ٣» + رسالة «تم تطبيق ٣» | 🟣 **جديدة** |
